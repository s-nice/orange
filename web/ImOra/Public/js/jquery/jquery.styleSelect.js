...
//			var selectId = 'selectbox_'+mainId+date.getTime();
			var selectId = 'selectbox_'+mainId;
			...
			//Options container
			var subContainer = $('<ul></ul>').css({'position' : 'absolute', 'z-index' : '5950', 'top' : opts.optionsTop, 'left' : opts.optionsLeft})
			...
			var doSelection = function(item){
				...
				realSelector.find('option[value="'+selectedItem+'"]').prop('selected','selected');
				realSelector.find('option[value="'+selectedItem+'"]').siblings().removeAttr('selected');
