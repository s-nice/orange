...
function Header(calendar, options) {
	...
	function updateTitle(html) {
		...
		element.find('h2')
			.html(html).attr({'year':year,'month':month});
	}
...
function BasicView(element, calendar, viewName) {
	...
	function buildTableHTML() {
		var html =
			"<table class='fc-border-separate' style='width:92%' cellspacing='0'>" +
			buildHeadHTML() +
			buildBodyHTML() +
			"</table>";
	...
	function buildCellHTML(date) {
		...
		html +=
			"<td" +
			" class='date_"+formatDate(date,'yyyyMMdd')+" " + classNames.join(' ') + "'" +
		...
		if (showNumbers) {//月视图天数数字显示
			...
			// html += "<div class='fc-day-number'><span class='holiday'>"+holiday+"</span><i class='dateshow'>" + date.getDate() + "</i><i style='display:none' class='datehide'>" + date.getDate() + "</i><span class='solarday'>"+ cnDay+"</span></div>";
			html += "<div class='fc-day-number'><span class='holiday'></span><i class='dateshow'>" + date.getDate() + "</i><i style='display:none' class='datehide'>" + date.getDate() + "</i><span class='solarday'>"+ cnDay+"</span></div>";
		}
