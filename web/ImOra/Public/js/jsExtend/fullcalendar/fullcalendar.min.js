...
g){g.style.height=Math.max(0,b-Sa(g,f))+"px"})}function fb(a,b){return(parseFloat(l.css(a,"paddingLeft",true))||0)+(parseFloat(l.css(a,"paddingRight",true))||0)+(parseFloat(l.css(a,"borderLeftWidth",true))||0)+(parseFloat(l.css(a,"borderRightWidth",true))||0)+(b?Vb(a):0)}function Vb(a){return(parseFloat(l.css(a,"marginLeft",true))||0)+(parseFloat(l.css(a,"marginRight",true))||0)}function Sa(a,b){return(parseFloat(l.css(a,"paddingTop",true))||0)+(parseFloat(l.css(a,"paddingBottom",
true))||0)+(parseFloat(l.css(a,"borderTopWidth",true))||0)+(parseFloat(l.css(a,"borderBottomWidth",true))||0)+(b?Bb(a):0)}function Bb(a){return(parseFloat(l.css(a,"marginTop",true))||0)+(parseFloat(l.css(a,"marginBottom",true))||0)}function Ra(a,b){b=typeof b=="number"?b+"px":b;a[0].style.cssText+=";min-height:"+b+";_height:"+b}function ib(){}function eb(a,b){return a-b}function Ab(a){return Math.max.apply(Math,a)}function Ma(a){return(a<10?"0":"")+a}function Wa(a,b){if(a[b]!==ha)return a[b];
