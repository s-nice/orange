    ...
    <div class="content_hieght">
        <div class="content_c">
            <div class="form_margintop">
                ...
                <div class="flex_num js_max_min">
                    <div class="min_num num_box">
                        <span>最小值:</span>
                        <input type="text" name="minValue" value="{$minValue}" />
                    </div>
                    <div class="min_num num_box">
                        <span>最大值:</span>
                        <input type="text" name="maxValue" value="{$maxValue}" />
                    </div>
                    <div class="min_num num_box">
                        <span>区间段:</span>
                        <input type="text" name="rangeValue" value="{$rangeValue}">
                    </div>
                    <input class="sure_b js_sub_another" type="button" value="确认">
                </div>
                </if>
            </div>
            <!--图表放置-->
