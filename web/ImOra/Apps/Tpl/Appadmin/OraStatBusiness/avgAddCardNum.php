		...
		<div class="content_c">
			<div class="form_margintop">
				...
				<div class="select_xinzeng margin_top menu_list">
					...
					<ul>
						<li class="on hand" href="{:U('Appadmin/OraStatBusiness/avgAddCardNum')}" type='total'>人均添加卡片数</li>
			...
			<div id="userStatisticsData">
				...
				<div class="table_content">
					<div class="table_list table_tit clear">
						...
						<span class="span_t4">人均添加卡片数(总)</span>
...
var URL="{:U('Appadmin/OraStatBusiness/avgAddCardNum')}";
