		...
		<div class="content_c">
			<div class="form_margintop">
				...
				<div class="select_xinzeng margin_top menu_list">
					<input type="text" value="人均使用卡片数量" readonly='readonly' autocomplete='off'>
					...
					<ul>
						...
						<li class="on hand" href="{:U('Appadmin/OraStatBusiness/avgUsedCardNum')}" type='total'>人均使用卡片数</li>
				...
				<div id='typeChange' class="select_xinzeng margin_top menu_list">
					...
					<i><img src="/images/appadmin_icon_xiala.png"></i>
					<ul>
						<li href="{:U('Appadmin/OraStatBusiness/avgUsedCardNum')}" type='total' <if condition="$type eq 'total'">class="on"</if>>总数</li>
						<li href="{:U('Appadmin/OraStatBusiness/avgUsedCardNum')}" type='brush' <if condition="$type eq 'brush'">class="on"</if>>可刷</li>
						<li href="{:U('Appadmin/OraStatBusiness/avgUsedCardNum')}" type='nobrush' <if condition="$type eq 'nobrush'">class="on"</if>>不可刷</li>
					</ul>
				</div>
			...
			<div id="userStatisticsData">
				...
				<div class="table_content">
					<div class="table_list table_tit">
						...
						<span class="span_t4">人均使用卡片数(总)</span>
...
var URL="{:U('Appadmin/OraStatBusiness/avgUsedCardNum')}";
