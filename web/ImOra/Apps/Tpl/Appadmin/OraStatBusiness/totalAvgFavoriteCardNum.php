		...
		<div class="content_c">
			<div class="form_margintop">
				...
				<div class="select_xinzeng margin_top menu_list">
					<input type="text" value="累计人均常用卡" readonly='readonly' autocomplete='off'>
					...
					<ul>
						...
						<li class="on hand" href="{:U('Appadmin/OraStatBusiness/totalAvgFavoriteCardNum')}">累计人均常用卡数</li>
			...
			<div id="userStatisticsData">
				...
				<div class="table_content">
					<div class="table_list table_tit" style="width:820px;">
						...
						<span class="span_t5">软件版本</span>
						<span class="span_t5">硬件版本</span>
						<span class="span_t5">航旅卡(占比)</span>
						<span class="span_t5">银行卡(占比)</span>
						<span class="span_t5">酒店卡(占比)</span>
						<span class="span_t5">会员卡(占比)</span>
						<span class="span_t5">门禁卡(占比)</span>
						<span class="span_t5">其他(占比)</span>
					</div>
					<div class="table_scrolls scroll_fix clear">
						<foreach name='list' item='v'>
						<div class="table_list clear" style="width:820px;">
							<span class="span_t5">{$v.dt}</span>
							<span class="span_t5">{$v.pro_version}</span>
							<span class="span_t5">{$v.model}</span>
							<span class="span_t5">{$v.card3}</span>
							<span class="span_t5">{$v.card1}</span>
							<span class="span_t5">{$v.card4}</span>
							<span class="span_t5">{$v.card15_19}</span>
							<span class="span_t5">{$v.card6}</span>
							<span class="span_t5">{$v.card0}</span>
						</div>
						</foreach>
					</div>
				</div>
