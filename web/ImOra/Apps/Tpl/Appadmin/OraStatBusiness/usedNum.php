		...
		<div class="content_c">
			<div class="form_margintop">
				...
				<div class="select_xinzeng margin_top menu_list">
					<input type="text" value="使用次数" readonly='readonly' autocomplete='off'>
					...
					<ul>
						...
						<li class='hand on' href="{:U('Appadmin/OraStatBusiness/usedNum')}">使用次数</li>
					</ul>
				</div>
				...
				<div class="select_xinzeng margin_top menu_list">
					...
					<i><img src="/images/appadmin_icon_xiala.png"></i>
					<ul>
						<li href="{:U('Appadmin/OraStatBusiness/usedNum')}" type='total' <if condition="$type eq 'total'">class="on"</if>>总数</li>
						<li href="{:U('Appadmin/OraStatBusiness/usedNum')}" type='tpl' <if condition="$type eq 'tpl'">class="on"</if>>模板</li>
						<li href="{:U('Appadmin/OraStatBusiness/usedNum')}" type='notpl' <if condition="$type eq 'notpl'">class="on"</if>>非模板</li>
					</ul>
				</div>
				<div class="select_xinzeng margin_top menu_list">
					<input type="text" value="总数" readonly='readonly' autocomplete='off'>
					...
					<ul>
						<li href="{:U('Appadmin/OraStatBusiness/usedNum')}" type='total' <if condition="$type eq 'total'">class="on"</if>>总数</li>
						<li href="{:U('Appadmin/OraStatBusiness/usedNum')}" type='brush' <if condition="$type eq 'brush'">class="on"</if>>可刷</li>
						<li href="{:U('Appadmin/OraStatBusiness/usedNum')}" type='nobrush' <if condition="$type eq 'nobrush'">class="on"</if>>不可刷</li>
					</ul>
				</div>
...
var URL="{:U('Appadmin/OraStatBusiness/usedNum')}";
