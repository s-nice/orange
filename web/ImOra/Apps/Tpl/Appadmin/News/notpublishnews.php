    ...
    <div class="content_hieght">
        <div class="content_c">
            <div class="content_search">
                <div class="right_search">
                    ...
                    <div class="select_time_c">
                        ...
                        <div class="time_c">
                            <input id="js_begintime" class="time_input" type="text" readonly="readonly" name="start_time" readonly="readonly" value="{$params['starttime']}" />
                            <i><img src="__PUBLIC__/images/appadmin_icon_xiala.png" /></i>
                        </div>
                        <span>--</span>
                        <div class="time_c">
                            <input id="js_endtime" class="time_input" type="text" readonly="readonly" name="end_time" value="{$params['endtime']}"/>
                            <i><img src="__PUBLIC__/images/appadmin_icon_xiala.png" /></i>
                        </div>
                    </div>
            ...
            <div class="section_bin">
                ...
                <a href="{:U('Appadmin/News/addPage')}"><div class="left_bin">{$T->str_news_add_news}</div></a>
                <span id="js_publishtoaudit" class="js_publishtoaudit"><i>{$T->str_news_submit_check}</i></span>
                <span id="js_btn_preview" data-type="2"><i>{$T->str_news_review}</i></span>
            ...
            <if condition="$rstCount neq 0">
                <foreach name="list" item="val">
                    <div class="sectionnot_list_c list_hover js_x_scroll_backcolor">
                        ...
                        <span class="span_span2   js_onenews_review " data-id="{$val['showid']}" data-type="1" title="{$val['title']}">{$val['title']}</span>
                        ...
                        <span class="span_span7 js_btn_opera_set" data-id="{$val['showid']}">
                            <a href="javascript:void(0)" onclick="window.open('{:U('Appadmin/News/editNews',array('id'=>$val['showid']),'','',true)}')" style="color: #666">
                    		<em class="hand " >{$T->str_btn_edit}</em>
                                </a>
                            |<i class="hand js_single_submit_check" data-id="{$val['showid']}" >{$T->str_news_submit_check}</i>
                    		|<b class="js_single_delete hand" data-id="{$val['showid']}" >{$T->str_delete}</b>
						</span>
                    </div>
                </foreach>
            <else/>
...
<script>
    var searchurl = "{:U('Appadmin/News/getNotPublishNews','','','',true)}";
