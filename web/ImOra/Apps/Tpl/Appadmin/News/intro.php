...
<div class="content_global">
    <div class="content_hieght">
        <div class="content_c">
	        ...
	        <br>
            <textarea class="js_content im-message-area" id="h5content" style="height:600px; word-break: break-all;overflow:hidden;"></textarea>
        </div>
    </div>
</div>
<!-- 配置文件 -->
...
var URL_DO_INTRO  = "{:U('Appadmin/News/doIntro')}";
