...
<div class="content_global">
    <div class="content_hieght">
        <div class="content_c">
            <div class="content_search">
                <div class="right_search">
                    ...
                    <div class="select_time_c">
                        ...
                        <div class="time_c">
                            <input id="js_begintime" class="time_input" type="text" readonly="readonly" name="start_time" value="{$params['starttime']}" />
            ...
            <div class="commentwait_list_name">
            ...
            <foreach name="list" item="val">
                <div class="commentwait_list_c list_hover js_x_scroll_backcolor">
