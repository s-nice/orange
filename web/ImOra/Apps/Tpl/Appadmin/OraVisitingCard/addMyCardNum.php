            ...
            <div id="userStatisticsData">
                ...
                <div class="table_content">
                    <div class="table_list table_tit">
                        ...
                        <span class="span_t1">总数</span>
                        <span class="span_t1">拍照名片数</span>
                        <span class="span_t1">录入名片数</span>
                    </div>
                        ...
                        <if condition="count($tableArr) gt 0">
                            <foreach name="tableArr" item="v">
                                <div class="table_list">
                                    ...
                                    <span class="span_t1">{$v.num}</span>
                                    <span class="span_t1">{$v.num1}</span>
                                    <span class="span_t1">{$v.num2}</span>
                                </div>
                            </foreach>
                            <else />
                            No Data
