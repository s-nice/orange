	...
	<div class="content_hieght">
		<div class="content_c">
			<div class="form_margintop">
				...
				<div id="js_stat_type" class="select_xinzeng margin_top js_se_div input_s_width">
				...
				<div id="js_child_type" class="select_xinzeng margin_top js_se_div input_s_width">
