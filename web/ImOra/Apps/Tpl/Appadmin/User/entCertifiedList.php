        ...
        <div class="content_c">
            <div class="content_search">
                <div class="right_search">
                    <form action="{:U('Appadmin/User/entCertifiedList','',false)}" method="get" >
                    <!-- 搜索关键字类型start -->
            		...
            		<!-- 搜索关键字类型end -->
                        ...
                        <div class="select_time_c">
                            <span>{$T->str_entuser_auth_time}<!-- 认证时间 --></span>
                            <div class="time_c">
            ...
            <div>
                <div class="entsection_list_name">
                    ...
                    <span class="span_span3">{$T->str_entuser_auth_time}<!-- 认证时间 --></span>
                    ...
                    <div class="entsection_list_c list_hover js_x_scroll_backcolor" >
                       ...
                       <span class="span_span3">
                            <empty name="val['createdtime']">
                                -----
                                <else />
                                <?php echo date('Y-m-d H:i',strtotime("+8 hour",$val['identtime'] ) ); ?>
                            </empty>
                        </span>
                        
                        <if condition="$val['state'] eq 'active'">
                       		 <span  class="span_span4">{$T->str_entuser_account_active}</span>
                        <elseif condition="$val['state'] eq 'blocked'"/>
                        ...
                        <a href="{:U('/Appadmin/User/entCertifyTpl/',array('id'=>$val['bizid'],'listType'=>2))}">
                         <span class="span_span7" >{$T->str_entuser_cancel_auth}<!-- 取消认证 --></span>
                        </a>
                    </div>
                </foreach>
                <empty name="list">
