        ...
        <div class="content_c">
            <div class="content_search">
                <div class="right_search">
                    <form action="{:U('Appadmin/User/perNotCertifiedUser','',false)}" method="get" >
            ...
            <div>
                <div class="usernotsection_list_name">
                    ...
                    <a href="{:U('/Appadmin/User/perNotCertifiedUser',$search)}" >
                    <span class="span_span6"><u style="float:left;">提交认证时间</u>
                    ...
                    <foreach name="list" item="val">
                        <div class="usernotsection_list_c list_hover js_x_scroll_backcolor" >
                            ...
                            <span class="span_span4">
                                <?php echo date('Y-m-d H:i:s',strtotime("+0 hour",$val['createtime'] ) ); ?>
                            </span>
                             <span class="span_span7 js_btn_opera_set" data-id="{$val['vcardid']}">
                                    <a href="{:U('/Appadmin/User/perNotCertifiedDetail/',array('id'=>$val['vcardid']))}">认证</a>
                            </span>
                        </div>
                    </foreach>
                    <else />
