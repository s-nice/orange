            ...
            <div id="userStatisticsData" class="">
            	...
            	<div class="Data_c_content">
            			<div class="Data_cjs_name cards_content_7">
		                  ...
		                  <span class="span_c_2">{$T->stat_active_usernum}</span>
		                  <span class="span_c_3">{$T->stat_active_addcard_usernum}</span>
		                  <span class="span_c_4">{$T->stat_active_addcard_userprop}</span>
		                </div>
