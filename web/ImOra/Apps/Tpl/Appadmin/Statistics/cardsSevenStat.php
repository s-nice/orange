            ...
            <div id="userStatisticsData" class="">
            	...
            	<div class="Data_c_content">
            			<div class="Data_cjs_name cards_content_7">
		                  ...
		                  <span class="span_c_2">{$T->stat_active_count_usernum}</span>
		                  <span class="span_c_3">{$T->stat_addcard_count_usernum}</span>
		                  <span class="span_c_4">{$T->stat_addcard_count_userprop}</span>
		                </div>
		            ...
		            <if condition="count($tableArr) gt 0">
		                <foreach name="tableArr" item="v" key='time'>
			                <div class="Data_c_list_z cards_content_7">
			                  ...
			                  <span class="span_c_2">{$v['activeusernum']}</span>
			                  <span class="span_c_3">{$v['usernum']}</span>
