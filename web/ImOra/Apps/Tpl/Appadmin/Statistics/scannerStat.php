            ...
            <div id="userStatisticsData" class="">
            	...
            	<div class="Data_c_content">
            			<div class="Data_cjs_name cards_content_7">
		                  ...
		                  <span class="span_c_2">{$T->stat_usescanner_num}</span>
		                  <span class="span_c_3">{$T->stat_usescanner_totalnum}</span>
		                  <span class="span_c_4">{$T->stat_usescanner_numprop}</span>
		                </div>
		            ...
		            <if condition="count($tableArr) gt 0">
		                <foreach name="tableArr" item="v" key='time'>
			                <div class="Data_c_list_z cards_content_7">
			                  ...
			                  <span class="span_c_2">{$v['bindscaner']}</span>
			                  <span class="span_c_3">{$v['total']}</span>
			                  <span class="span_c_4">{$v['average']}</span>
			                </div>
		                </foreach>
		            <else/>
		              No Data
