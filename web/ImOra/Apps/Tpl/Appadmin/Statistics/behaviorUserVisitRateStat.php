    ...
    <div class="content_hieght">
        <div class="content_c">
            ...
            <div id="userStatisticsData" class="">
            	<div class="Data_bt">
            	  <span class="left_s">{$T->stat_sheet_user_visit_rate}</span>
            	...
            	<div class="Data_c_content stat_behavior_rate">
		                <div class="Data_search_name">
						  ...
						  <span class="span_c_5">{$T->stat_module_name}</span>
						  <span class="span_c_6">{$T->stat_user_visit_rate}</span>
		                </div>
...
<script>
var sheetTitle="{$T->stat_user_visit_rate}(%)";
