        ...
        <div class="content_c">
            ...
            <div id="userStatisticsData" class="">
            	<div class="Data_bt Data_bt_top">
            		<span class="left_s">{$itemselectArr[$itemselect]}{$T->stat_table_title}</span>
