        ...
        <div class="content_c">
            ...
            <div id="userStatisticsData" class="">
            	<div class="Data_bt Data_bt_top">
            	  <span class="left_s">{$T->stat_sheet_total_visit_users}</span>
            	...
            	<div class="Data_c_content stat_behavior_sheet">
		                <div class="Data_search_name">
						  ...
						  <span class="span_c_5">{$T->stat_total_visit_users}</span>
						  <span class="span_c_5">{$T->stat_l2_module_name}</span>
						  <span class="span_c_6">{$T->stat_total_visit_users}</span>
		                </div>
...
var sheetTitle = "{$T->stat_total_visit_users}";
