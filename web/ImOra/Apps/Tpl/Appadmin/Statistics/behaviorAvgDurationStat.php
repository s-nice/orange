    ...
    <div class="content_hieght">
        ...
        <div class="form_margintop">
            ...
            <div id="userStatisticsData" class="">
            	<div class="Data_bt">
            	  <span class="left_s">{$T->stat_sheet_avg_visit_duration}</span>
            	...
            	<div class="Data_c_content stat_behavior_sheet">
		                <div class="Data_search_name">
						  ...
						  <span class="span_c_5">{$T->stat_avg_visit_duration}</span>
						  <span class="span_c_5">{$T->stat_l2_module_name}</span>
						  <span class="span_c_6">{$T->stat_avg_visit_duration}</span>
		                </div>
...
<script>
var sheetTitle="{$T->stat_avg_visit_duration}";
