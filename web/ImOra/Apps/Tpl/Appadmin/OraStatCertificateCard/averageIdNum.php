		...
		<div class="content_c">
			<div class="form_margintop">
				...
				<div class="select_xinzeng margin_top js_select_menu js_select_action" >
					<input type="text" value="累计人均证件卡数" title="累计人均证件卡数">
				...
				<div class="select_xinzeng margin_top js_select_menu js_select_card_status">
					<input type="text" value="<if condition= "$cardStatus eq 'disabled'">不可刷<elseif condition= "$cardStatus eq 'on'"/>可刷<else/>总数</if>">
					<i><img src="/images/appadmin_icon_xiala.png"></i>
					<ul>
						<li val="">总数</li>
						<li val="on">可刷</li>
						<li val="disabled">不可刷</li>
					</ul>
				</div>
			</div>
			<!-- 图表放置 -->
			...
			<div id="userStatisticsData">
				<div class="Data_bt">
					<span class="left_s">累计人均证件卡数数据表</span>
				...
				<div class="table_content">
					<div class="table_list table_tit">
						...
						<span class="span_t1">累计人均证件卡数</span>
					</div>
