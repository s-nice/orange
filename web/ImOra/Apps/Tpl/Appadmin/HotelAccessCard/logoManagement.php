    ...
    <div class="content_hieght">
        <div class="content_c js_listcontent">
            <div class="right_search">
                <form  id="js_search_form" method="get" action="{:U('Appadmin/HotelAccessCard/logoManagement','',false)}">
                    <input type="hidden" name="sort" value="{$params['sort']}">
                    <input  class="s_key" type="text"  placeholder="输入LOGO名称" name="keyword"
            ...
            <div class="vipcard_list gave_card userpushlist_name fa_card js_list_name_title">
                ...
                <span class="span_span4">LOGO名称</span>
            ...
            <if condition="$data['data']['numfound'] gt 0">
                <volist name="data['data']['list']" id="list" key="k">
                    <div class="overflow-visibal gave_card checked_style userpushlist_c list_hover js_x_scroll_backcolor fa_card js_list_one">
...
<div class="oraq-dialog " style="display:none;" id="js_add_wrap">
    <div class="input-i xin-input">
        <span>LOGO名称:</span> <input class="input-text js_name_input" type="text" placeholder="LOGO名称" >
    </div>
    <div class="num_BIN num_file xin-input clear ">
        <span>上传图片：</span>
        <input type="file" style="width:55px;" id="js_logoimg" name="picfile">
        <button type="button" class="js_upload_button">上传</button>
    </div>
    <div class="i_logo clear xin-logo js_logoimg_show">
...
<script>
    ...
    var gUrl="{:U('Appadmin/HotelAccessCard/logoManagement')}";
    var gAddUrl="{:U('Appadmin/HotelAccessCard/addLogo')}";
    var gUpdateUrl="{:U('Appadmin/HotelAccessCard/updateLogo')}";
    var gDelUrl="{:U('Appadmin/HotelAccessCard/delLogo')}";
    var gType=1;
    $(function(){
