...
<div class="content_global">
	<div class="content_hieght">
		<div class="content_c">
			...
			<div class="company_name clear">
				<h4>输入公司别名：</h4>
				<input type="text" id="js_alias_name_input" placeholder='输入多个别名以&ldquo;,&rdquo;号隔开'>
			...
			<div class="alias_btn clear">
				...
				<a href="{:U('Appadmin/OraCompanyAlias/index','','','',true)}"><button class="big_button" type="button">取消</button></a>
			</div>
		</div>
	</div>
</div>
<script>
	var gSaveUrl="{:U('Appadmin/OraCompanyAlias/saveAlias','','','',true)}"
