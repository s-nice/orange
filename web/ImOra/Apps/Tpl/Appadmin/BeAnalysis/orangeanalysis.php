        	...
        	<div class="form_margintop">
	            <div class="content_search">
	                <div class="search_right_c">
	                    <div class="select_IOS js_select_item menu_list" id="js_selectIOS">
                        ...
                        <div class="select_time_c">
                            ...
                            <div class="time_c">
                                <input id="js_begintime" class="time_input" type="text" name="start_time" readonly value="{$startTime}" />
                                <i><img src="__PUBLIC__/images/appadmin_icon_xiala.png" /></i>
                            </div>
                            <span>--</span>
                            <div class="time_c">
                                <input id="js_endtime" class="time_input" type="text" name="end_time" readonly value="{$endTime}"/>
                                <i><img src="__PUBLIC__/images/appadmin_icon_xiala.png" /></i>
                            </div>
            ...
            <div id="userStatisticsData" class="">
                ...
                <div class="Data_c_content">
                    <div class="Data_c_name">
                        <span class="span_c_1" style='width:150px;'>{$T->stat_date}</span>
                        <span class="span_c_1" style='width:150px;'>{$T->stat_sys_platform}</span>
                        <span class="span_c_1" style='width:150px;'>{$secondSelect}</span>
                        <span class="span_c_1" style='width:150px;'>{$T->str_orange_visit_count}</span>
                        <span class="span_c_2" style='width:150px;'>{$secondSelect}{$T->str_orange_rate}</span>
                    </div>
                    <div class="js_c_content">
                    <if condition="count($noZeroData) gt 0">
                        <volist name="userStats" id="_userStat">
                            <if condition="$_userStat.user_count neq 0">
                            <div class="Data_c_list">
                                <span class="span_c_1" style='width:150px;'>{$_userStat.date1}</span>
                                <span class="span_c_1" style='width:150px;'>{$_userStat.sys_platform}</span>
                                <span class="span_c_1" style='width:150px;'>{$_userStat.user_count}</span>
                                <span class="span_c_1" style='width:150px;'>{$_userStat.visit_count}</span>
                                <span class="span_c_2" style='width:150px;'>{$_userStat.user_percent}</span>
                            </div>
                            </if>
                        </volist>
                    <else/>
