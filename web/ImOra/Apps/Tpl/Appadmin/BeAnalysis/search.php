	                ...
	                <div class="search_right_c">
	                    ...
	                    <div class="select_sketch menu_list js_select_item js_multi_select">
	                        ...
	                        <ul class="hand js_sel_ul" id="js_productversionul">
                                <li class="on" class='js_all_in_one' val="{$T->stat_prod_version}" title="{$T->stat_prod_version}">{$T->stat_prod_version}</li>
            ...
            <div id="userStatisticsData" class="">
                ...
                <div class="Data_c_content">
                    <div class="Data_search_name">
                        <span class="span_c_1" style="width: 144px;">{$T->stat_date}</span>
                        <span class="span_c_1" style="width: 144px;">{$T->stat_sys_platform}</span>
                        <span class="span_c_1" style="width: 144px;">{$T->stat_prod_version}</span>
                        <span class="span_c_1" style="width: 144px;">{$secondSelect}</span>
                        <span class="span_c_6" style="width: 144px;">{$secondSelect}{$T->str_search_per}</span>
                    </div>
                    ...
                    <if condition="count($noZeroData) gt 0">
                        <volist name="userStats" id="_userStat">
                            ...
                            <div class="Data_search_list">
                                <span class="span_c_1" style="width: 144px;">{$_userStat.date1}</span>
                                <span class="span_c_1" style="width: 144px;">{$_userStat.sys_platform}</span>
                                <span class="span_c_1" style="width: 144px;" title="{$_userStat.prd_version}">{$_userStat.prd_version}</span>
                                <span class="span_c_1" style="width: 144px;">{$_userStat.searched_count}</span>
                                <span class="span_c_6" style="width: 144px;">{$_userStat.searched_percent}</span>
                            </div>
                            </if>
                        </volist>
                        <else/>
...
<script type="text/javascript">
    ...
    var jsSearchUseNum = '{$T->str_search_use_number}';   //搜索功能使用数
