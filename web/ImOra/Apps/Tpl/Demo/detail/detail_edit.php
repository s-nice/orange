...
<body style='display:none;'>
    <form id="form1" action="{:U('wechat/showCardDetail','','',true)}" method="post" onsubmit="return checkdatas()">
...
<script>
    ...
    $(document).ready(function() {
        ...
        if(data){
            ...
            if(side == 'front'){
                if(js_isself==1){
                    var wDetailZpUrl = "{:U(MODULE_NAME.'/Wechat/wDetailZp',array('isMenu'=>'1','cardid'=>$cardid,'android'=>$android),'',true)}";
                }else{
