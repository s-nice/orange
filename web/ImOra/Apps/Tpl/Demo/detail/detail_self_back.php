...
<section class="min_height">
	<section class="my_main">
		<div class="img_top">
			...
			<ul class="img_list">
				<li>
					<img src="{$info.picpathb}" class="js_vcard_img {$isBack}" alt="" />
				</li>
			</ul>
		...
		<section class="info_content z_index js_content_dom">
			<div class="bg_info">
				<div class="text_info">
                    ...
                    <a href="{:U('Wechat/showCardDetail',array('cardid'=>$cardid,'side'=>'back','android'=>$isAndroid),'',true)}">
			...
			<div class="j_info">
				<div class="info_center">
					...
					<div class="j_item">
						...
						<p>
                            <foreach name="info['back']['ADR']" item="vo">
