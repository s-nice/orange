        ...
        <section class="info_content z_index js_content_dom" >
            <div class="bg_info" id="js_showdown_show">
                ...
                <if condition="$ismycreate eq 1">
                    <a href="{:U('CompanyCard/bizCardEdit',array('cardid'=>$cardid,'side'=>'back','android'=>$isAndroid,'openid'=>$openid),'',true)}">
...
var gVcardDetailBackUrl = "{:U(MODULE_NAME.'/CompanyCard/wDetailZp',array('keyword'=>$kwd,'cardid'=>$cardid,'openid'=>$openid,'android'=>$isAndroid,'isMy'=>$isMy),'',true)}"; //名片反面url
