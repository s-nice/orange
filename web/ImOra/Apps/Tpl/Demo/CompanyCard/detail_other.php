	...
	<section class="my_main">
		<div class="img_top js_cardimg_dom">
			...
			<ul class="img_list" id="js_showdown_hide">
				<li>
                    <img class="js_vcard_img {$isBack}" src="{$info.picpatha}" alt="" />
				</li>
			</ul>
            ...
            <div class="bg_info" id="js_showdown_show">
                <div class="text_info">
                    <dl class="icon_text">
                        ...
                        <dd>
                            <div class="name">
                                <span>{$info['front']['FN'][0]}</span>
                                <notempty name="info['front']['JOB']">
                                    <em>{$info['front']['JOB'][0]}</em>
                                </notempty>
                ...
                <if condition="$ismycreate eq 1">
                <a href="{:U('CompanyCard/bizCardEdit',array('cardid'=>$cardid,'side'=>'front','android'=>$isAndroid,'openid'=>$openid),'',true)}">
			...
			<div class="j_info">
				<div class="info_center">
					...
					<div class="j_item">
						...
						<p>
                            <foreach name="info['front']['ADR']" key="keys" item="vals">
    ...
    <div class="js_no_weui big_no_weui">
        <div class="no_weui">
            <div class="three_btns">
                ...
                <div class="hint_btn hint_color hint_border">{$info['front']['FN'][0]}的名片.vcf</div>
                <a class="js_no_weui" href="{:U('h5/exchange/downloadFile',array('fid'=>$vcardid,'name'=>$info['front']['FN'][0],),'',true)}"><div class="hint_btn hint_color">立即下载</div></a>
            </div>
...
var js_url_sharecard = "{:U(MODULE_NAME.'/CompanyCard/shareCardToComp','','',true)}";
var gGetLocationUrl = "{:U(MODULE_NAME.'/CompanyCard/getLocation','','',true)}";
var gVcardListUrl = "{:U(MODULE_NAME.'/CompanyCard/wListZp',array('keyword'=>$kwd,'openid'=>$openid,'android'=>$isAndroid,'isMy'=>$isMy),'',true)}";
var gVcardDetailBackUrl = "{:U(MODULE_NAME.'/CompanyCard/detailBack',array('keyword'=>$kwd,'cardid'=>$cardid,'openid'=>$openid,'android'=>$isAndroid,'isMy'=>$isMy),'',true)}"; //名片反面url
