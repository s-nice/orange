...
<script src="__PUBLIC__/js/jsExtend/md5.js?v={:C('WECHAT_APP_VERSION')}&t=<?php time();?>"></script>
<script type="text/javascript">
    var appId          = "wxd74253d6ee55fe12";
    var secretkey      = "ecd90fa62cd26bb716ebad464fca2fda";
    var extend         = "imora";    　　　 //开发者自定义参数集合
    var timestamp      = new Date().getTime();　　　　//时间戳(毫秒)
    var shop_id        = "3446260";            　　  //AP设备所在门店的ID
    var authUrl        = "__URL_/listener";
    var mac            = "3c:91:57:c2:cc:af";  　　　//用户手机mac地址 安卓设备必需
    var ssid           = "WXtest";           //AP设备信号名称，非必须
