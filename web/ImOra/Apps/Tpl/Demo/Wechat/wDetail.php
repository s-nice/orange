...
<body>
    <!-- <button type="button" id='upload'>上传图片测试</button> -->
	<div class="warmp">
		<!-- <div class="search_top">
			<div class="search_text">
				<input id='search' placeholder="请输入搜索内容" type="text"><span><img src="__PUBLIC__/images/soud.png"></span>
			</div>
		...
		<div class="content_info">
			...
			<div class="back_list"><button type="button" id='back'>返回列表页</button></div>
		</div>
	</div>
	<!-- 
	<div class="sound_bg">
