...
<!-- 			<img class="ab_img" src="__PUBLIC__/images/wbg.jpg" id='uploadLocalImg'>
 -->
<div class="w_center">	
    <div id="hasBindScanner" style="">	
     		<div class="w_shu w_bottom"><span>扫描仪:<i id="scannerName" style=""><input type="input" name="scannerInfo" id="scannerInfo"></i></span></div>
    </div>
      <div class="cls_opera_scanner" ><button id="startScannerBtn"  data-status="2" class="weui-btn weui-btn_primary w_bottom " >生成二维码</button></div>
