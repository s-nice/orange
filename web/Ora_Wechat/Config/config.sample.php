...
return array(
        'APP_VERSION'           => '3.1.8', // 版本标识。
        'DEFAULT_MODULE'        =>  'Company',  // 默认模块
        // 基本配置。 ！！！不要修改！！！
        ...
        'LOAD_EXT_CONFIG'       => 'ApiInterfaceMaps', // the extended config files to be loaded
        'WEB_SERVICE_ROOT_URL'  => 'http://192.168.30.191:9996', // 运营后台 API 根路径
        ...
        'DB_TYPE'               => 'mysql',     // 数据库类型
        'DB_HOST'               => '192.168.30.191', // 数据库主机地址
        'DB_NAME'               => 'oradt_cloud',          // 数据库名称
