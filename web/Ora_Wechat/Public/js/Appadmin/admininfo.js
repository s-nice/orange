$(function(){
		...
		if(oldpasswd==''){
			...
			if(oldpasswd!='' ||oldpasswd!=null){
				...
				if(!passwd_is_true){
					...
					$('#tx_oldpasswd').html("<img src='"+public+"/images/Appadmin/appadmin_icon_yanzheng.png' />");
					return ;
				}				
			}
		}
	...
	$('#newpasswd').on('blur',function(){
		...
		if(newpasswd==''){
			...
			$('#tx_newpasswd').html("<img src='"+public+"/images/Appadmin/appadmin_icon_yanzheng.png' />");
		}
	...
	$('#renewpasswd').on('blur',function(){
		...
		if(renewpasswd==''){
			...
			$('#tx_renewpasswd').html("<img src='"+public+"/images/Appadmin/appadmin_icon_yanzheng.png' />");
		}		
	});
