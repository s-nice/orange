...
//                }
            ...
            warning: function (obj) {
                ...
                $('#gMessageWarning' + divId).find('.public_pop_c , .margin_auto').css({
                    width: obj.width + 'px',
            ...
            addMsgHtml: function () {
                ...
                info += '<div id="gTitle" class="gTitle_title"><span id="gInfo"></span><span id="gClose" class="gConfirmClose gMessageClose_bin"><img src="' + gPublic + 'images/icons/cards_close_img.png" /></span></div>';
