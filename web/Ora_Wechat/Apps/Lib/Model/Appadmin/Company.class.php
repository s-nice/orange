...
class company extends WebService
{
    /**
     * 企业信息 操作接口( 修改、查询)
    ...
    public function doRequest($params=array(), $crud='R')
    {
        ...
        switch ($crud){
            case 'R'://获取
                $webServiceRootUrl = C("API_ADMIN_COMPANY_INFO");
           ...
           /* case 'C'://创建
            ...
            /*    case 'D'://删除(暂时没有此功能)
                    ...
                    break;*/
            case 'U'://修改企业状态
                $webServiceRootUrl = C("API_ADMIN_COMPANY_STATUS_EDIT"); //
                break;
            default:
    ...
    public function manageCompanyInfo($params=array(), $crud='R')
    {
