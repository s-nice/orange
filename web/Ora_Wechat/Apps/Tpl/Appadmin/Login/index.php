...
<html>
    <head>
        ...
        <title>Login</title>
        <link rel="shortcut icon" href="__PUBLIC__/images/Appadmin/favicon.ico">
        <link href="__PUBLIC__/css/Appadmin/appadmin.css" rel="stylesheet" type="text/css">
        <link href="__PUBLIC__/css/Appadmin/globalPop.css" rel="stylesheet" type="text/css">
    </head>
<body>
 <div class="appadmin_login" id="tbposition">
	<div class="appadmin_login_c">
		<div class="appadmin_login_b"><img src="__PUBLIC__/images/Appadmin/appadmin_login_banner.jpg" /></div>
		<div class="addmin_login_img"><img src="__PUBLIC__/images/Appadmin/appadmin_login_img.png" /></div>
	</div>
...
<script src="__PUBLIC__/js/Appadmin/globalPop.js"></script>
...
<script src="__PUBLIC__/js/Appadmin/login.js"></script>
</body>
</html>