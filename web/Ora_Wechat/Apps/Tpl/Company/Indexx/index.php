		...
		<div class="if-input">
			<div class="if-input-item clear">
				<div class="if-big-m">
					...
					<input class="more-i-d hand creator" type="text" autocomplete='off' placeholder="创建者" ng-click="visibleAccount=!visibleAccount" ng-model="paramSearchDetail.ename"/>
		...
		<div class="l-content">
				...
				<div class="page tnone">
                    <div>
                        ...
                        <form class="ng-pristine ng-valid">
                            <input style="width:25px;" class="jumppage" type="text" ng-model='pg'>
                            <input value="跳转" type='button' ng-click="doTurnPage(pg)">
                        </form>
                    </div>
                </div>
                <!--名片墙按钮-->
			...
			<div class="table-list">
				<table class="card-table">
					<thead class="t-head">
						<tr>
							<td class="col-sm-1 col-md-1">
								<label class="input-th" for=""><input ng-model="all" type="checkbox" autocomplete='off'/><em></em></label>
							</td>
					...
					<tbody class="t-body tnone">
					  <tr ng-repeat="v in dataCards">
					  	<td class="td1 col-sm-1 col-md-1">
					  		<label class="input-th" for="">
                    			<input aa='{{v.vcardid}}' ng-checked="all" ng-model="dataCards[$index]['checked']" ng-change="selectCard()" type="checkbox" autocomplete='off'/>
                    			<em></em>
                    		</label>
					  	</td>
...
<div class="x-dialog info-dialog" ng-show="visibleInfoWindow">
	<div class="x-main">
		...
		<div class="x-content x-qu-height"  ng-show='paramCardInfoTag==1'>
			<div class="qu-item-x clear">	
				<div class="tit-ch">
					<h3>有权查看的同事</h3>
					<button type="button" ng-click="doShowShareWindow('emp')">添加</button>
				</div>
				<ul class="look-list">
					<li>
					...
					<li type='1' ng-class="{true:'active'}[v.visibleShareDelBtn]" ng-repeat="v in dataEmpDept.emps|filter:{checked:true}" ng-mouseover="v.visibleShareDelBtn=true" ng-mouseout="v.visibleShareDelBtn=false">
			...
			<div class="qu-item-x clear">	
				<div class="tit-ch">
					<h3>有权查看的部门</h3>
					<button type="button" ng-click="doShowShareWindow('dept')">添加</button>
				</div>
				<ul class="look-list">
		...
		<div class="x-content">
			...
			<div class="edit-form back" ng-show="!visibleFrontInEditWindow">
				<div class="edit-form-item" ng-repeat="v in dataBack.FN track by $index">
					<span>姓名</span>
					<input class="ed-i-input" type="text" autocomplete='off' name='FN' max='6' value='{{v}}' ng-keyup="doChangeValueInEditWindow($event,'backFront', $index)" ng-blur="doChangeValueInEditWindow($event,'backFront', $index)"/>
					<em class="add-i-ed icon-edit" ng-click="doAddItemInEditWindow('FN','backFront')"></em>
					<em class="remove-i-ed icon-edit" ng-click="doRemoveItemInEditWindow('FN','backFront',$index)" ng-hide="$index==0"></em>
					<p class="error-p clear none"></p>
				</div>
				<div class="edit-form-item clear" ng-repeat="v in dataBack.ORG track by $index">
					<span>公司</span>
					<input class="ed-i-input" type="text" autocomplete='off' name='ORG' max='30' value='{{v}}' ng-keyup="doChangeValueInEditWindow($event,'backFront', $index)" ng-blur="doChangeValueInEditWindow($event,'backFront', $index)"/>
					<em class="add-i-ed icon-edit" ng-click="doAddItemInEditWindow('ORG','backFront')"></em>
					<em class="remove-i-ed icon-edit" ng-click="doRemoveItemInEditWindow('ORG','backFront',$index)" ng-hide="$index==0"></em>
					<p class="error-p clear none"></p>
				</div>
				<div class="edit-form-item clear" ng-repeat="v in dataBack.DEPAR track by $index">
					<span>部门</span>
					<input class="ed-i-input" type="text" autocomplete='off' name='DEPAR' max='12' value='{{v}}' ng-keyup="doChangeValueInEditWindow($event,'backFront', $index)" ng-blur="doChangeValueInEditWindow($event,'backFront', $index)"/>
					<em class="add-i-ed icon-edit" ng-click="doAddItemInEditWindow('DEPAR','backFront')"></em>
					<em class="remove-i-ed icon-edit" ng-click="doRemoveItemInEditWindow('DEPAR','backFront',$index)" ng-hide="$index==0"></em>
					<p class="error-p clear none"></p>
				</div>
				<div class="edit-form-item clear" ng-repeat="v in dataBack.TITLE track by $index">
					<span>职位</span>
					<input class="ed-i-input" type="text" autocomplete='off' name='TITLE' max='12' value='{{v}}' ng-keyup="doChangeValueInEditWindow($event,'backFront', $index)" ng-blur="doChangeValueInEditWindow($event,'backFront', $index)"/>
					<em class="add-i-ed icon-edit" ng-click="doAddItemInEditWindow('TITLE','backFront')"></em>
					<em class="remove-i-ed icon-edit" ng-click="doRemoveItemInEditWindow('TITLE','backFront',$index)" ng-hide="$index==0"></em>
					<p class="error-p clear none"></p>
				</div>
				<div class="edit-form-item clear" ng-repeat="v in dataBack.CELL track by $index">
					<span>手机</span>
					<input class="ed-i-input" type="mobile_" autocomplete='off' name='CELL' value='{{v}}' ng-keyup="doChangeValueInEditWindow($event,'backFront', $index)" ng-blur="doChangeValueInEditWindow($event,'backFront', $index)" />
					<em class="add-i-ed icon-edit" ng-click="doAddItemInEditWindow('CELL','backFront')"></em>
					<em class="remove-i-ed icon-edit" ng-click="doRemoveItemInEditWindow('CELL','backFront',$index)" ng-hide="$index==0"></em>
					<p class="error-p clear none"></p>
				</div>
				<div class="edit-form-item clear" ng-repeat="v in dataBack.TEL track by $index">
					<span>工作电话</span>
					<input class="ed-i-input" type="text" autocomplete='off' name='TEL' value='{{v}}' ng-keyup="doChangeValueInEditWindow($event,'backFront', $index)" ng-blur="doChangeValueInEditWindow($event,'backFront', $index)" />
					<em class="add-i-ed icon-edit" ng-click="doAddItemInEditWindow('TEL','backFront')"></em>
					<em class="remove-i-ed icon-edit" ng-click="doRemoveItemInEditWindow('TEL','backFront',$index)" ng-hide="$index==0"></em>
					<p class="error-p clear none"></p>
				</div>
				<div class="edit-form-item clear" ng-repeat="v in dataBack.EMAIL track by $index">
					<span>邮箱</span>
					<input class="ed-i-input" type="email_" autocomplete='off' name='EMAIL' value='{{v}}' ng-keyup="doChangeValueInEditWindow($event,'backFront', $index)" ng-blur="doChangeValueInEditWindow($event,'backFront', $index)" />
					<em class="add-i-ed icon-edit" ng-click="doAddItemInEditWindow('EMAIL','backFront')"></em>
					<em class="remove-i-ed icon-edit" ng-click="doRemoveItemInEditWindow('EMAIL','backFront',$index)" ng-hide="$index==0"></em>
					<p class="error-p clear none"></p>
				</div>
				<div class="edit-form-item clear" ng-repeat="v in dataBack.ADR track by $index">
					<span>地址</span>
					<input class="ed-i-input" type="text" autocomplete='off' name='ADR' max='70' value='{{v}}' ng-keyup="doChangeValueInEditWindow($event,'backFront', $index)" ng-blur="doChangeValueInEditWindow($event,'backFront', $index)"/>
					<em class="add-i-ed icon-edit" ng-click="doAddItemInEditWindow('ADR','backFront')"></em>
					<em class="remove-i-ed icon-edit" ng-click="doRemoveItemInEditWindow('ADR','backFront',$index)" ng-hide="$index==0"></em>
					<p class="error-p clear none"></p>
				</div>
				<div class="edit-form-item clear" ng-repeat="v in dataBack.URL track by $index">
					<span>网址</span>
					<input class="ed-i-input" type="text" autocomplete='off' name='URL' max='25' value='{{v}}' ng-keyup="doChangeValueInEditWindow($event,'backFront', $index)" ng-blur="doChangeValueInEditWindow($event,'backFront', $index)"/>
					<em class="add-i-ed icon-edit" ng-click="doAddItemInEditWindow('URL','backFront')"></em>
					<em class="remove-i-ed icon-edit" ng-click="doRemoveItemInEditWindow('URL','backFront',$index)" ng-hide="$index==0"></em>
					<p class="error-p clear none"></p>
				</div>
			</div>
