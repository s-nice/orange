        ...
        <div class="division-con js_contents">
            <div class="divi-right">
                <div class="main">
                    ...
                    <div class="inner">
                        <div class="payment_inner">
                            <div class="payment_title">{$payTitle}</div>
                            <!--左边开始-->
                            <form action="/payment/renew?act=check" id="order_form" target="_blank" method="post">
                                <input type="hidden" id="order_id" name="order_id" value="539460-719ee90bfdf08cc46a86ab01a">
                                <div class="plan_left">
                                    <div class="p_l_title">1.当前套餐： 基础版 (¥30/人/月)</div>
                                    <div class="calculate">
                                        <div class="calculate_top">
                                            <!--用户数-->
                                            <div class="yonghushuBox">
                                                <div class="yhsTop">
                                                    <div class="c_t_btn01_L minus_no"></div>
                                                    <div class="c_t_text01">
                                                        <input type="text" minval="3" maxval="0" name="person" id="person" value="3" class="calculate_txt" maxlength="5">
                                                    </div>
                                                    <div class="c_t_btn01_R plus_yes"></div>
                                                    <div class="clear_fd"></div>
                                                </div>
                                                <div class="calculate_top_txt1">人</div>
                                            </div>
                                            <!--乘号-->
                                            <div class="c_t_multiply"></div>
                                            <!--月数-->
                                            <div class="yueshuBox">
                                                <div class="yhsTop">
                                                    <div class="c_t_btn02_L minus_no"></div>
                                                    <div class="c_t_text02">
                                                        <input type="text" minval="1" name="month" id="month" value="1" class="calculate_txt">
                                                    </div>
                                                    <div class="c_t_btn02_R plus_yes"></div>
                                                </div>
                                                <div class="calculate_top_txt1">月</div>
                                            </div>
                                            <!--乘号-->
                                            <div class="c_t_multiply"></div>
                                            <!--每人每月-->
                                            <div class="meirenmeiyueBox">
                                                <div class="mrmyTop">
                                                    <div class="c_t_text03"><span style="margin-left: 0px;">¥</span>
                                                        <p id="plan_unit">{$price}</p>
                                                    </div>
                                                    <div class="clear_fd"></div>
                                                </div>
                                                <div class="calculate_top_txt_mrmy">每人每月</div>
                                            </div>
                                            <!--合计、等于-->
                                            <div class="c_t_amount"></div>
                                            <!--套餐总价-->
                                            <div class="meirenmeiyueBox">
                                                <div class="mrmyTop">
                                                    <div class="c_t_totalprice"><span>¥</span>
                                                        <p id="plan_total">90</p>
                                                    </div>
                                                    <div class="clear_fd"></div>
                                                </div>
                                                <div class="calculate_top_txt_mrmy">套餐总价</div>
                                            </div>
                                        </div>
                                        <!--我要购买快速识别张数附加包-开始-->
                                        <div class="buy_check">
                                            <span class="iu_checkbox_input check_fujiabao" id="fujiabao"></span>
                                            <label for="fujiabao" id="fujiabao_label">购买更多精准校验张数</label>
                                        </div>
                                        <div class="fast_track_wrap">
                                            <div class="calculate_buyshujubao">
                                                <!--用户数-->
                                                <div class="yonghushuBox2">
                                                    <div class="yhsTop">
                                                        <div class="c_t_btn01_L minus_no"></div>
                                                        <div class="c_t_text01">
                                                            <input type="text" minval="0" name="piece" id="piece"
                                                                   value="0" class="calculate_txt">
                                                        </div>
                                                        <div class="c_t_btn01_R plus_yes"></div>
                                                        <div class="clear_fd"></div>
                                                    </div>
                                                    <div class="calculate_top_txt1">
                                                        10个以上享九折优惠
                                                    </div>
                                                </div>
                ...
                ¥                </span>
                                                    ...
                                                    <div class="calculate_top_txt_mrmy">
                                                        每十张价格
                                                    </div>
                                                </div>
                                                <!--合计、等于-->
                                                <div class="c_t_amount"></div>
                                                <!--附加包单价-->
                                                <div id="track_unit" style="display:none;">4.50</div>
                                                <div class="meirenmeiyueBox">
                                                    <div class="mrmyTop">
                                                        <div class="c_t_totalprice"><span>
                ¥                </span>
                                                            <p id="track_total">0</p>
                                                        </div>
                                                        <div class="clear_fd"></div>
                                                    </div>
                                                    <div class="calculate_top_txt_mrmy">
                                                        共<span id="below_piece_total">0</span>张
                                                    </div>
                                                </div>
                                                <!--save 19%-->
                                                <div class="c_t_Percent" id="card_save_result" style="display: none;">
                                                    <span id="span_jiesheng" class="card_save_percent">节省</span>
                                                    <span id="card_save_percent" class="card_save_percent">
              10%              </span></div>
                                            </div>
                                        </div>
                                    </div>
                                    <input type="hidden" value="dcad5518d9464a51c7c58222fb50894c" id="_csrf_token" name="YII_CSRF_TOKEN">
                                    <div class="clear_fd"></div>
                                    <input type="hidden" id="payment" name="payment" value="4">
                                    <div class="p_l_title">2.
                                        选择付款方式
                                    </div>
                                    <!--其他环境下选择付款方式-->
                                    <div class="mode_tab" id="payment_method">
                                        <div class="com_payment_li payment_alipay">
                                            <span class="iu_radio_input orderlist_radio iu_radio_selected"
                                                  id="payment_1" payment_value="alipay"></span>
                                            <label for="payment_1" class="tablabel" id="payment_1_label">
                                                <div class="alipay_img"></div>
                                            </label>
                                        </div>
                                        <div class="com_payment_li payment_yinlian">
                                            <span class="iu_radio_input orderlist_radio" id="payment_3"
                                                  payment_value="netpay"></span>
                                            <label for="payment_3" class="tablabel" id="payment_3_label">
                                                <div class="other_img_china"></div>
                                            </label>
                                        </div>
                                    ...
                                    <!--发票信息-->
                                    <div class="clear_fd"></div>
                                    <div class="p_l_title p_title_3" id="pay_mode_title">3.
                                        发票信息
                                    </div>
                                    <input type="hidden" name="invoice" id="invoice_type" value="">
                                    <div class="mode_tab" id="invoice_information">
                                        <div class="tabWrap">
                                            <span class="iu_radio_input orderlist_radio li_wz1_1 iu_radio_selected"
                                                  id="invoice_1" invoice_value="2"></span>
                                            <label for="invoice_1" class="tablabel li_wz1_2" id="invoice_1_label">
                                                不需要发票 </label>
                                        </div>
                                        <div class="tabWrap">
                                            <span class="iu_radio_input orderlist_radio li_wz2_1 " id="invoice_2"
                                                  invoice_value="3"></span>
                                            <label for="invoice_2" class="tablabel li_wz2_2" id="invoice_2_label">
                                                增值税普通发票 </label>
                                        </div>
                                        <div class="tabWrap tabLast">
                                            <span class="iu_radio_input orderlist_radio li_wz3_1 " id="invoice_3"
                                                  invoice_value="4"></span>
                                            <label for="invoice_3" class="tablabel li_wz3_2" id="invoice_3_label">
                                                增值税专用发票 </label>
                                        </div>
                                    </div>
                                    <div class="clear_fd"></div>
                                    <div class="invoice_body">
                                        <!--增值税普通发票-->
                                        <div class="invoice_form" id="invoice_form_normal" style="display:none;">
                                            <div class="invoice_txt2">
                                                <div class="txt2_title">
                                                    发票抬头
                                                </div>
                                                <input type="text" class="txt2_input" placeholder="个人名称或单位名称"
                                                       name="taitou" id="taitou" value="北京橙鑫数据科技有限公司">
                                            </div>
                                            <div class="invoice_txt2">
                                                <div class="txt2_title">
                                                    收信人
                                                </div>
                                                <input type="text" class="txt2_input" name="receiver" id="receiver"
                                                       value="严巍">
                                            </div>
                                            <div class="clear_fd"></div>
                                            <div class="invoice_txt2">
                                                ...
                                                <input type="text" class="txt2_input" name="mobile" id="mobile"
                                                       value="18601903157">
                                            </div>
                                            <div class="invoice_txt2">
                                                <div class="txt2_title">
                                                ...
                                                <input type="text" class="txt2_input" name="address" id="address"
                                                       value="北京市朝阳区小亮马桥路安家楼1号院7号楼">
                                            </div>
                                            <div class="clear_fd"></div>
                                            <div class="invoice_txt2" style="width:100%;">
                                                <div class="txt2_title">
                                                    邮编
                                                </div>
                                                <input type="text" class="txt2_input" name="zipcode" id="zipcode"
                                                       value="100125">
                                            </div>
                                        </div>
                                        <!--增值税专用发票-->
                                        <div class="invoice_form" id="invoice_form_special" style="display:none;">
                                            <div class="clear_fd"></div>
                                            <div class="invoice_step invoice_step_1">
                                                步骤一：填写增值税专用发票信息
                                            </div>
                                            <div class="invoice_step1">
                                                <div class="invoice_txt2">
                                                    <div class="txt2_title">
                                                        发票抬头
                                                    </div>
                                                    <input type="text" class="txt2_input" placeholder="个人名称或单位名称"
                                                           name="special_taitou" id="special_taitou" value="">
                                                </div>
                                                <div class="invoice_txt2">
                                                    <div class="txt2_title">
                                                        公司地址
                                                    </div>
                                                    <input type="text" class="txt2_input" name="special_address"
                                                           id="special_address" value="">
                                                </div>
                                                <div class="clear_fd"></div>
                                                <div class="invoice_txt2">
                                                    <div class="txt2_title">
                                                    ...
                                                    <input type="text" class="txt2_input" name="special_mobile"
                                                           id="special_mobile" value="">
                                                </div>
                                                <div class="invoice_txt2">
                                                    <div class="txt2_title">
                                                        邮编
                                                    </div>
                                                    <input type="text" class="txt2_input" name="special_zipcode"
                                                           id="special_zipcode" value="">
                                                </div>
                                                <div class="clear_fd"></div>
                                                <div class="invoice_txt2">
                                                    <div class="txt2_title">
                                                    ...
                                                    <input type="text" class="txt2_input" name="special_bank_account"
                                                           id="special_bank_account" value="">
                                                </div>
                                                <div class="invoice_txt2">
                                                    <div class="txt2_title">
                                                        开户行
                                                    </div>
                                                    <input type="text" class="txt2_input" name="special_bank"
                                                           id="special_bank" value="">
                                                </div>
                                                <div class="clear_fd"></div>
                                                <div class="invoice_txt2">
                                                    <div class="txt2_title">
                                                    ...
                                                    <input type="text" class="txt2_input" name="special_tariff"
                                                           id="special_tariff" value="">
                                                </div>
                                                <div class="clear_fd"></div>
                                            </div>
                                            <div class="clear_fd"></div>
                                            <div class="invoice_step">
                                                步骤二：填写联系方式
                                            </div>
                                            <div class="invoice_step2">
                                                <div class="invoice_txt2">
                                                    <div class="txt2_title">
                                                        收信人
                                                    </div>
                                                    <input type="text" class="txt2_input" name="special_receiver"
                                                           id="special_receiver" value="">
                                                </div>
                                                <div class="invoice_txt2">
                                                    <div class="txt2_title">
                                                        手机号码
                                                    </div>
                                                    <input type="text" class="txt2_input" name="special_receiver_mobile"
                                                           id="special_receiver_mobile" value="">
                                                </div>
                                                <div class="clear_fd"></div>
                                                <div class="invoice_txt2">
                                                    <div class="txt2_title">
                                                    ...
                                                    <input type="text" class="txt2_input"
                                                           name="special_receiver_address" id="special_receiver_address"
                                                           value="">
                                                </div>
                                                <div class="invoice_txt2">
                                                    <div class="txt2_title">
                                                    ...
                                                    <input type="text" class="txt2_input"
                                                           name="special_receiver_zipcode" id="special_receiver_zipcode"
                                                           value="">
                                                </div>
                                                <div class="clear_fd"></div>
                                            </div>
                                            <div class="clear_fd"></div>
                                            <div class="invoice_txt1">
                                                注：首次开具增值税专用发票的客户，请先填写增票信息，然后提供加盖公章的营业执照副本、税务登记证副本、一般纳税人资格证明、银行开户许可证扫描件，通过邮件发送至invoice@intsig.com，并注明您的用户名，我们收到您的开票信息后，会尽快审核。
                                            </div>
                                        </div>
                                    </div>
                                    <div style="display:none"><b id="lang_payment_title">请您在新打开的页面上完成付款</b><b
                                                id="lang_payment_tip">付款完成前请不要关闭此窗口！<br>完成付款后，请根据您的情况点击下面的按钮：</b><b
                                                id="lang_repay">重新付款</b><b id="lang_pay_ok">完成付款</b><b
                                                id="lang_artificial_service">付款已收到，订单处理中出现异常，请联系我们：vipsupport@intsig.com</b><b
                                                id="lang_upgrade_advisor">友情提示</b><b id="lang_upgrade_tip">您选择的人数已超过套餐上限，您可以升级套餐添加更多成员。</b><b
                                                id="lang_cancel">取消</b><b id="lang_upgrade_plan">升级套餐</b><b
                                                id="lang_cancel_order">您已经有一个未付款的订单。<br>点击“取消”返回首页，或者“继续”创建新订单？</b><b
                                                id="lang_continue_plan">继续</b><b
                                                id="lang_field_empty_error">此项不能为空</b><b
                                                id="lang_continue_plan">继续</b><b id="lang_buy_maximum_person">已经超过购买上限，请联系我们，我们将为您提供更多优惠和定制服务。</b><b
                                                id="lang_contactus">联系我们</b><b
                                                id="lang_agreement_error">请勾选此项目，代表您同意该条款</b><b
                                                id="lang_purchase_channel_deny">您没有线上付费权限，请线下付费</b><b id="lang_i_know">我知道了</b><b
                                                id="lang_offline_receivew_money_error_tip"></b><b
                                                id="lang_payment_change_type">请更改支付方式</b><b
                                                id="lang_payment_alipay_tip">您的订单已超过支付宝单笔2000元的付款限额，请您改用银联支付，或者拨打我们的客服电话4006-083-063</b><b
                                                id="lang_payment_use_unionpay">使用银联支付</b><b
                                                id="lang_use_other_payment_contact">由于支付金额超限，请拨打我们的客服电话400-608-3063</b><b
                                                id="lang_use_chinapay">更换银联支付</b><b id="lang_use_other_payment">请选择其他支付方式</b>
                                    </div>
                                </div>
                            </form>
                            <!--左边结束-->
                            ...
                            <div class="plan_right">
                                ...
                                <div class="settlement">
                                    <div class="jiesuan_inner">
                                        <div class="js_title">
                                            订单详情
                                        </div>
                                        <div class="js_line"></div>
                                        <div class="js_box1">
                                            <div class="js_b1_title">
                                                已选套餐：
                                            </div>
                                            <div class="js_b1_txt">
                                                <div class="txt_left"><span class="total_person">3</span>
                                                    人<span class="user_many"></span> ×<span class="total_month">1</span>
                                                    月<span class="month_many"></span></div>
                                            </div>
                                            <div class="js_b1_txt">
                                                <div class="txt_left"><span class="plan_piece">0</span>
                                                    精准校验张数<span class="plan_track_many"></span></div>
                                            </div>
                                            <div class="js_b1_txt total_sum">
                                                ¥ <span id="plan_total_sum">90</span></div>
                                        </div>
                                        <div class="js_line"></div>
                                        <div class="js_box1">
                                            <div class="js_b1_title">更多精准校验张数:</div>
                                            <div class="js_b1_txt">
                                                <div class="txt_left"><span class="additional_piece">0</span>精准校验张数<span
                                                            class="other_track_many"></span></div>
                                            </div>
                                            <div class="js_b1_txt">
                                                <div class="txt_right">¥ <span id="track_total_sum">0</span></div>
                                            </div>
                                        </div>
                                        <div class="js_line"></div>
                                        <div class="js_box2" style="height:auto;">
                                            <div class="js_b2_title">
                                                合计：
                                            </div>
                                            <div class="js_b2_txt"><span class="total_person">3</span>
                                                人<span class="user_many"></span></div>
                                            <div class="js_b2_txt"><span class="total_month">1</span>
                                                月<span class="month_many"></span></div>
                                            <div class="js_b2_txt">
                                                <div class="txt2_left"><span class="total_piece">0</span>
                                                    精准校验张数<span class="track_many"></span></div>
                                            </div>
                                            <div class="js_b2_txt txt2_total_sum">
                                                <div class="txt2_right">
                                                    ¥ <span id="total_sum">90</span></div>
                                            </div>
                                        </div>

                                        <div class="js_line"></div>
                                        <div class="btn_buy" id="btn_buy_confirm">
                                            立即购买
                                        </div>
                                        <div class="js_box3">
                                            <span class="iu_checkbox_input iu_checkbox_check check_user_agreement"
                                                  id="user_agreement"></span>
                                            <label for="user_agreement" id="user_agreement_label">
                                                我同意<a href="/payment/agreement" target="_blank">《名片全能王企业版付费协议》</a>
                                            </label>
                                        </div>
                                    </div>
                                </div>
                                <!--帮助支持-->
                                <div class="help_support" id="help_support">
                                    <div class="help_inner">
                                        <div class="help_title">
                                            联系客服
                                        </div>
                                        <div class="help_txt">
                                            客服邮箱： <a href="mailto:vipsupport@intsig.com">vipsupport@intsig.com</a>
                                        </div>
                                        <div class="help_txt">
                                            电话：4006-083-063
                                        </div>
...
<script>
    ...
    var buySUiteUrl = '{:U("buySuite")}';
    var renewSuiteUrl = '{:U("renewSuite")}';
    $(function () {
        $('#btn_buy_confirm').on('click', function () {
            var buyType = $('input[name=buyType]').val();
//            console.log(buyType);
            ...
            if(buyType==='3'){
                ...
                $.post(addStaffUrl,data, function (res) {
                   console.log(res)
                }, 'json')
            }else if(buyType==='1'){
                data.num = num;
                data.month = month;
                data.platform = platform;
                $.post(buySUiteUrl,data, function (res) {
                   console.log(res)
                }, 'json')
            }else if(buyType==='2'){
                data.month = month;
                data.platform = platform;
                $.post(renewSuiteUrl,data, function (res) {
                   console.log(res)
                }, 'json')
            }
