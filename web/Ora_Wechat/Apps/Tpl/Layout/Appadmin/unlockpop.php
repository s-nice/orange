...
<div class="appadmin_unlock_c js_lockscreenpop" style="display: none;">
	<div class="appadmin_unlock_close"><img src="__PUBLIC__/images/Appadmin/appadmin_icon_close.png" /></div>
	<div class="appadmin_unlock_content">
		<div class="left appadmin_unlock_img"><img src="__PUBLIC__/images/Appadmin/appadmin_icon_ickey.png" /></div>
...
<div class="appadmin_dropout js_logoutpop">
	<div class="appadmin_unlock_close"><img class="cursorpointer js_logoutcancel" src="__PUBLIC__/images/Appadmin/appadmin_icon_close.png" /></div>
...
<div class="Push_comment_pop" style='display: none;'>
	<div class="Push_comment_close"><img class="cursorpointer js_btn_channel_cancel" src="__PUBLIC__/images/Appadmin/appadmin_icon_close.png" /></div>
	<div class="Push_commentpop_c">
		...
		<div class="Pushwidth_max">
			...
			<div class="Push_erweima"><img src="__PUBLIC__/images/Appadmin/appadmin_icon_erwm.png" /></div>
			<div class="Administrator_bin Administrator_masttop">
...
<div class="New_comment_pop" style='display: none;'>
	<div class="New_comment_close"><img class="cursorpointer js_btn_channel_cancel" src="__PUBLIC__/images/Appadmin/appadmin_icon_close.png" /></div>
	<div class="New_commentpop_c">
		<div class="New_title">新增合作商</div>
			...
			<div class="New_name">
	            ...
	            <em id="js_seltitle"><img src="__PUBLIC__/images/Appadmin/appadmin_icon_xiala.png"></em>
	            <ul id="js_selcontent">
		...
		<div class="waif_password"><span>合作商名称</span><input type="text" name="sort" value=""  /><img src="__PUBLIC__/images/Appadmin/new_icon_bz.png" /></div>
		<div class="waif_password"><span>邮箱</span><input type="text" name="sort" value=""  /><img src="__PUBLIC__/images/Appadmin/new_icon_bz.png" /></div>
		<div class="waif_password"><span>联系人</span><input type="text" name="sort" value=""  /><img src="__PUBLIC__/images/Appadmin/new_icon_bz.png" /></div>
		<div class="waif_password"><span>联系人电话</span><input type="text" name="sort" value=""  /><img src="__PUBLIC__/images/Appadmin/new_icon_bz.png" /></div>
		<div class="waif_usertext">
			<span>所属行业</span>
			<div class="New_name">
	            <span class="span_name">
