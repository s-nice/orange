<div class="appadmin_header">
	<span></span>
	<p><i title="{$admin_info['realname']}">您好！{$admin_info['username']}！</i><em>[<u style="overflow: hidden; text-overflow: ellipsis; white-space: nowrap; display: inline-block; max-width: 57px; height: 13px;" title="{$admin_info['userType']}">{$admin_info['userType']}</u>]</em></p>
